...
urlpatterns = [
    ...
    path(
        "facilitators-list/",
        views.FacilitatorListTableView.as_view(),
        name="facilitators_list",
    ),
    path(
        "facilitators-percent/<slug:id>/",
        views.FacilitatorsPercentListView.as_view(),
        name="facilitator_percent",
    ),
    path(
        "facilitators-percent/",
        views.FacilitatorsPercentView.as_view(),
        name="facilitators_percent",
    ),
